...
replace (
	...
	// Updated for ArgoCD v3.0.3 compatibility
	github.com/improbable-eng/grpc-web => github.com/improbable-eng/grpc-web v0.15.0

	// Transitive dependency, used by github.com/argoproj/pkg/cron
	// Updated for ArgoCD v3.0.3 compatibility
	...
	// Updated K8s replaces for ArgoCD v3.0.3, targeting k8s.io/* v0.33.0
	...
	// Updated for ArgoCD v3.0.3 - corresponds to k8s.io/* v0.33.0
